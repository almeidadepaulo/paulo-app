(function() {
    ...
    angular.module('seeawayApp').controller('SmsUploadCtrl', SmsUploadCtrl);

    SmsUploadCtrl.$inject = ['config', 'exampleService', '$rootScope', '$scope', '$state', '$mdDialog'];

    function SmsUploadCtrl(config, exampleService, $rootScope, $scope, $state, $mdDialog) {
        ...
        function initFlow() {
            return {
                ...
                target: config.REST_URL + '/sms/upload',
                query: {
                    type: 'sms-upload'
                }
            };
