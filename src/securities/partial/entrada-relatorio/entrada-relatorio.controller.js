        ...
        function filterDialog(model, item) {
            ...
            switch (model) {
                case 'banco':
                    ...
                    templateUrl = 'securities/partial/banco/banco-dialog.html';
                    break;

                case 'agencia':
                    controller = 'AgenciaDialogCtrl';
                    templateUrl = 'securities/partial/agencia/agencia-dialog.html';
                    locals = { banco: vm.filter.banco };
                    break;

                case 'conta':
                    controller = 'ContaDialogCtrl';
                    templateUrl = 'securities/partial/conta/conta-dialog.html';
                    locals = {
                ...
                case 'produto':
                    ...
                    templateUrl = 'securities/partial/produto/produto-dialog.html';
                    break;
                ...
                case 'analitico':
                    ...
                    templateUrl = 'securities/partial/entrada-relatorio/entrada-analitico-dialog.html';
                    break;
            }
