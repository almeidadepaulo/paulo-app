...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_BN019_REMESSA_HIST]'))
DROP VIEW [dbo].[VW_BN019_REMESSA_HIST]
GO

-- Cria View
CREATE VIEW [dbo].[VW_BN019_REMESSA_HIST]
WITH ENCRYPTION
AS
  SELECT 
