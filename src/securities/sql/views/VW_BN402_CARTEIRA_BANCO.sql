...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_BN402_CARTEIRA_BANCO]'))
DROP VIEW [dbo].[VW_BN402_CARTEIRA_BANCO]
GO

-- Tela Carteira - Entrada por Banco
-- Cria View
CREATE VIEW [dbo].[VW_BN402_CARTEIRA_BANCO]
WITH ENCRYPTION
AS
 SELECT 
 	BN402_NR_GRUPO,
