...
AS
  SELECT 
	...
	*/
	...
	/*
	-- TOTAL DE CONTRATOS QUE ESTÃO COMO STATUS DE DEVOLUÇÃO COMO PENDENTE
	,ISNULL(
		(
			SELECT	COUNT(1) 
			FROM	BN201
	...
	*/
	...
	/*
	-- TOTAL DE CONTRATOS QUE ESTÃO COMO STATUS DE DEVOLUÇÃO COMO ACEITO
	,ISNULL(
		(
			SELECT	COUNT(1) 
			FROM	BN201
	...
	*/
	...
	/*
	-- TOTAL DE CONTRATOS QUE ESTÃO COMO STATUS DE DEVOLUÇÃO COMO RECUSADO
	,ISNULL(
		(
			SELECT	COUNT(1) 
			FROM	BN201
	...
	*/
	...
	-- TOTAL DE CONTRATOS QUE ESTÃO COMO STATUS DE DEVOLUÇÃO COMO FINALIZADA
	/*
	,ISNULL(
		(
			SELECT	COUNT(1) 
	...
	*/
	...
	/*
	,BN205.BN205_TT_COINST -- Este campo está 'recebendo' o select abaixo:
	*/
