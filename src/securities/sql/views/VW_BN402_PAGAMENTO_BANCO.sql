...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_BN402_PAGAMENTO_BANCO]'))
DROP VIEW [dbo].[VW_BN402_PAGAMENTO_BANCO]
GO

-- Tela Carteira - Pagamento por Banco
-- Cria View
CREATE VIEW [dbo].[VW_BN402_PAGAMENTO_BANCO]
WITH ENCRYPTION
AS
 SELECT 
 	BN402_NR_GRUPO,
