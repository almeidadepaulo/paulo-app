...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_BN402_CARTEIRA_PRODUTO]'))
DROP VIEW [dbo].[VW_BN402_CARTEIRA_PRODUTO]
GO

-- Entrada por Produto
-- Cria View
CREATE VIEW [dbo].[VW_BN402_CARTEIRA_PRODUTO]
WITH ENCRYPTION
AS
 SELECT 
	BN402_NR_GRUPO,
