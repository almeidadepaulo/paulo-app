...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_BN402_PAGAMENTO_PRODUTO]'))
DROP VIEW [dbo].[VW_BN402_PAGAMENTO_PRODUTO]
GO

-- Pagamento por Produto
-- Cria View
CREATE VIEW [dbo].[VW_BN402_PAGAMENTO_PRODUTO]
WITH ENCRYPTION
AS
 SELECT 
	BN402_NR_GRUPO,
