...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB209_ENTRADA_CARTEIRA]'))
DROP VIEW [dbo].[VW_CB209_ENTRADA_CARTEIRA]
GO

-- Entrada por Carteira
-- Cria View
CREATE VIEW [dbo].[VW_CB209_ENTRADA_CARTEIRA]
WITH ENCRYPTION
AS
 SELECT 
	CB209_NR_OPERADOR,
