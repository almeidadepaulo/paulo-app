...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB208_FLUXO_MENSAL_CARTEIRA]'))
DROP VIEW [dbo].[VW_CB208_FLUXO_MENSAL_CARTEIRA]
GO

-- Carteira - Fluxo Mensal por Produto
-- Cria View
CREATE VIEW [dbo].[VW_CB208_FLUXO_MENSAL_CARTEIRA]
WITH ENCRYPTION
AS
 SELECT 
	CB208_NR_OPERADOR,
