...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB209_ENTRADA_PRODUTO]'))
DROP VIEW [dbo].[VW_CB209_ENTRADA_PRODUTO]
GO

-- Entrada por Produto
-- Cria View
CREATE VIEW [dbo].[VW_CB209_ENTRADA_PRODUTO]
WITH ENCRYPTION
AS
 SELECT 
	CB209_NR_OPERADOR,
...
ON     CB255_NR_OPERADOR = CB209_NR_OPERADOR
 ...
 WHERE  CB209_ID_TIPOAC = 2 /* ENTRADA */
