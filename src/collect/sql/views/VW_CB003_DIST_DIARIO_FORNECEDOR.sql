...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB003_DIST_DIARIO_FORNECEDOR]'))
DROP VIEW [dbo].[VW_CB003_DIST_DIARIO_FORNECEDOR]
GO

-- PUBLISH - Publicações -  Distribuição por fornecedor diário
	
-- Cria View
CREATE VIEW [dbo].[VW_CB003_DIST_DIARIO_FORNECEDOR]
WITH ENCRYPTION
AS
