...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB003_DRA]'))
DROP VIEW [dbo].[VW_CB003_DRA]
GO

-- PUBLISH - Publicações -  Distribuição por região anual
	
-- Cria View
CREATE VIEW [dbo].[VW_CB003_DRA]
WITH ENCRYPTION
AS
