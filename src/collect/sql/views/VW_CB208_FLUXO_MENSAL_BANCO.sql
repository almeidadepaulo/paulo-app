...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB208_FLUXO_MENSAL_BANCO]'))
DROP VIEW [dbo].[VW_CB208_FLUXO_MENSAL_BANCO]
GO

-- Carteira - Fluxo Mensal por Banco
-- Cria View
CREATE VIEW [dbo].[VW_CB208_FLUXO_MENSAL_BANCO]
WITH ENCRYPTION
AS
 SELECT 
  CB208_NR_OPERADOR,
