...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB003_DIST_MENSAL_FORNECEDOR]'))
DROP VIEW [dbo].[VW_CB003_DIST_MENSAL_FORNECEDOR]
GO

-- PUBLISH - Publicações -  Distribuição por fornecedor mensal
	
-- Cria View
CREATE VIEW [dbo].[VW_CB003_DIST_MENSAL_FORNECEDOR]
WITH ENCRYPTION
AS
...
SELECT
  ...
  SUBSTRING(CONVERT(VARCHAR, FLOOR(CB003_DT_MOVTO / 100)), 5, 2) CB003_DT_MES,
  FLOOR(CB003_DT_MOVTO / 10000) CB003_DT_ANO,
...
/* CB003 -> CB055 */
AND CB003_NR_INST   = CB055_NR_INST
AND CB003_CD_FORNEC = CB055_CD_FORNEC
--AND SUBSTRING(CONVERT(VARCHAR, FLOOR(CB003_DT_MOVTO / 100)), 5, 2) = 201301
GROUP BY 
  CB003_NR_INST,
  CB003_CD_EMIEMP,
  CB053_DS_EMIEMP,
  ...
  CB003_CD_FORNEC,
  CB055_NM_FORNEC,
  FLOOR(CB003_DT_MOVTO / 100),
  SUBSTRING(CONVERT(VARCHAR, FLOOR(CB003_DT_MOVTO / 100)), 5, 2),
  FLOOR(CB003_DT_MOVTO / 10000)
/* ORDER BY
  CB003_DT_MOVTO ,
  CB003_CD_PUBLIC,
  CB003_CD_FORNEC */
