...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB003_DFA]'))
DROP VIEW [dbo].[VW_CB003_DFA]
GO

-- PUBLISH - Publicações -  Distribuição por fornecedor anual
	
-- Cria View
CREATE VIEW [dbo].[VW_CB003_DFA]
WITH ENCRYPTION
AS
