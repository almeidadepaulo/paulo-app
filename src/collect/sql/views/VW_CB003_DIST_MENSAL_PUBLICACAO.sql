...
-- Apaga view
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VW_CB003_DIST_MENSAL_PUBLICACAO]'))
DROP VIEW [dbo].[VW_CB003_DIST_MENSAL_PUBLICACAO]
GO

-- PUBLISH - Publicações -  Distribuição por publicação mensal

-- Cria View
CREATE VIEW [dbo].[VW_CB003_DIST_MENSAL_PUBLICACAO]
WITH ENCRYPTION
AS
