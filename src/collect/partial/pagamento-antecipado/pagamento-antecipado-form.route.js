(function() {
    ...
    function configure($stateProvider) {
        $stateProvider.state('pagamento-antecipado-form', getState());
    }

    function getState() {
        return {
            url: '/pagamento-antecipado-form/:CB210_NR_OPERADOR/:CB210_NR_CEDENTE/:CB210_CD_COMPSC/:CB210_NR_AGENC/:CB210_NR_CONTA/:CB210_NR_NOSNUM/:CB210_NR_CPFCNPJ/:CB210_NR_PROTOC',
            templateUrl: 'collect/partial/pagamento-antecipado/pagamento-antecipado-form.html',
            controller: 'PagamentoAntecipadoFormCtrl',
            controllerAs: 'vm',
            parent: 'home',
            params: {
