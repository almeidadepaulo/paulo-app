(function() {
    ...
    angular.module('seeawayApp').controller('PagamentoAntecipadoCtrl', PagamentoAntecipadoCtrl);

    PagamentoAntecipadoCtrl.$inject = ['config', 'pagamentoService', '$rootScope', '$scope', '$state', '$stateParams', '$mdDialog', 'PAGAMENTO'];

    function PagamentoAntecipadoCtrl(config, pagamentoService, $rootScope, $scope, $state, $stateParams, $mdDialog, PAGAMENTO) {
        ...
        function update(id) {
            $state.go('pagamento-antecipado-form', id);
        }
