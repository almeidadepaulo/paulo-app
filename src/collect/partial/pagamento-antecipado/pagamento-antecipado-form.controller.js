(function() {
    ...
    angular.module('seeawayApp').controller('PagamentoAntecipadoFormCtrl', PagamentoAntecipadoFormCtrl);

    PagamentoAntecipadoFormCtrl.$inject = ['$state', '$stateParams', '$mdDialog', 'pagamentoService', 'getData', '$filter',
        'PAGAMENTO'
    ];

    function PagamentoAntecipadoFormCtrl($state, $stateParams, $mdDialog, pagamentoService, getData, $filter,
        PAGAMENTO) {
