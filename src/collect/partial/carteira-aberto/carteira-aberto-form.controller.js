(function() {
    ...
    angular.module('seeawayApp').controller('CarteiraAbertoFormCtrl', CarteiraAbertoFormCtrl);

    CarteiraAbertoFormCtrl.$inject = ['$state', '$stateParams', '$mdDialog', 'pagamentoService', 'getData', '$filter',
        'PAGAMENTO'
    ];

    function CarteiraAbertoFormCtrl($state, $stateParams, $mdDialog, pagamentoService, getData, $filter,
        PAGAMENTO) {
