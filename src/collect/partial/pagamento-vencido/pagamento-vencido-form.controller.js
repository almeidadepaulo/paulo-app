(function() {
    ...
    angular.module('seeawayApp').controller('PagamentoVencidoFormCtrl', PagamentoVencidoFormCtrl);

    PagamentoVencidoFormCtrl.$inject = ['$state', '$stateParams', '$mdDialog', 'pagamentoService', 'getData', '$filter',
        'PAGAMENTO'
    ];

    function PagamentoVencidoFormCtrl($state, $stateParams, $mdDialog, pagamentoService, getData, $filter,
        PAGAMENTO) {
