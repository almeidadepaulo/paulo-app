(function() {
    ...
    angular.module('seeawayApp').controller('UploadCtrl', UploadCtrl);

    UploadCtrl.$inject = ['config', '$rootScope', '$scope', '$state', '$mdDialog'];

    function UploadCtrl(config, $rootScope, $scope, $state, $mdDialog) {
        ...
        function initFlow() {
            return {
                ...
                target: config.REST_URL + '/collect/upload',
                query: {
                    type: 'collect-upload'
                }
            };
        ...
        function removeSuccessLine(event, index, file, transfers) {
            ...
            if (vm.transfersFinished.length === transfers.length) {
                ...
                $mdDialog.show(
                    ...
                    .title('Aviso')
                    .textContent('Arquivos enviados com sucesso!')
                    .ariaLabel('Aviso')
                    .ok('Fechar')
                );
