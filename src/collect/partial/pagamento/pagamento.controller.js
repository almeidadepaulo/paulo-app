(function() {
    ...
    angular.module('seeawayApp').controller('PagamentoCtrl', PagamentoCtrl);

    PagamentoCtrl.$inject = ['config', 'pagamentoService', '$rootScope', '$scope', '$state', '$stateParams', '$mdDialog', 'PAGAMENTO'];

    function PagamentoCtrl(config, pagamentoService, $rootScope, $scope, $state, $stateParams, $mdDialog, PAGAMENTO) {
