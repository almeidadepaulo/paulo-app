(function() {
    ...
    angular.module('seeawayApp').controller('UploadDialogCtrl', UploadDialogCtrl);

    UploadDialogCtrl.$inject = ['config', 'exampleService', '$rootScope', '$scope', '$state', '$mdDialog'];

    function UploadDialogCtrl(config, exampleService, $rootScope, $scope, $state, $mdDialog) {
