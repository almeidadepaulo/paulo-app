(function() {
    ...
    UploadCtrl.$inject = ['config', 'exampleService', '$rootScope', '$scope', '$state', '$mdDialog'];

    function UploadCtrl(config, exampleService, $rootScope, $scope, $state, $mdDialog) {
        ...
        function initFlow() {
            return {
                ...
                target: config.REST_URL + '/contabil/upload',
                query: {
