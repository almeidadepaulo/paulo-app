(function() {
    ...
    angular.module('seeawayApp').controller('ContaSiclidFormCtrl', ContaSiclidFormCtrl);

    ContaSiclidFormCtrl.$inject = ['$state', '$stateParams', '$mdDialog', 'exampleService', 'getData'];

    function ContaSiclidFormCtrl($state, $stateParams, $mdDialog, exampleService, getData) {
