(function() {
    ...
    angular.module('seeawayApp').controller('LancamentoFormCtrl', LancamentoFormCtrl);

    LancamentoFormCtrl.$inject = ['$state', '$stateParams', '$mdDialog', 'exampleService', 'getData'];

    function LancamentoFormCtrl($state, $stateParams, $mdDialog, exampleService, getData) {
