<cfcomponent rest="true" restPath="sms/upload">  
	...
	<cffunction name="fake" access="remote" returntype="String" httpmethod="POST"> 
		...
		<cfset checkAuthentication(state = ['sms-upload'])>
		<cfset cedenteValidate()>
        
		<cfset destination = getDirectoryFromPath(getCurrentTemplatePath()) & "\..\..\..\_server\publish\sms">
