			...
			<cftransaction>
				<cfquery datasource="#application.datasource#" name="query" result="result">
					...
					VALUES (					
						...
						0,
						0,
						<cfqueryparam value = "#body.per_tipo#" CFSQLType = "CF_SQL_TINYINT">,
						<cfqueryparam value = "#session.grupoId#" CFSQLType = "CF_SQL_BIGINT">
					);
				</cfquery>

				<cfif IsDefined("body.jstreeDataCedente")>
					<cfloop array="#body.jstreeDataCedente#" index="i">
			...
			<cftransaction>					
				...
				<cfquery datasource="#application.datasource#">
					...
					SET 
						...
						per_tipo = <cfqueryparam value = "#body.per_tipo#" CFSQLType = "CF_SQL_TINYINT">
					WHERE 
			...
			<cfquery datasource="#application.datasource#" name="qCedente">
				SELECT
					...
					,(SELECT 
							COUNT(1) 
						FROM 
							dbo.perfil_cedente AS perfil_check 
						WHERE 
							perfil_check.cedente_id = CB053.CB053_CD_EMIEMP
				...
				<!---
					LEFT OUTER JOIN dbo.perfil_cedente AS  perfil_cedente
					ON CB053.CB053_CD_EMIEMP = perfil_cedente.cedente_id
					AND CB053.CB053_NR_INST = perfil_cedente.grupo_id

					WHERE CB053_CD_EMIEMP IN (<cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.perfil_cedente#" list="true">)					
					AND grupo_id = <cfqueryparam cfsqltype="cf_sql_bigint" value="#arguments.operador#">
				--->
				<!--- Todos os cedentes --->
